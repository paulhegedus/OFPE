...
Note that if you choose to execute the code below and add all associated data, this will take an additional >10GB memory. If testing on the server where you plan to store your OFPE database you should have at least 5-10x this much space dedicated to your OFPE data, depending on the size and number of your farmers, farms, and fields.
