...
modClass <- ModClass$new(fxn = list(yld = "GAM",
                                    pro = "NonLinear_Logistic"),
                         fxn_path = NULL,
                         SAVE = TRUE,
                         out_path = "~/Desktop/")
```
...
```{r, eval = FALSE}
modClass$setupOP() # setup outputter stuff (folder)
modClass$setupMod(datClass) # pass in data, process data, initialize model in model class based on user inputs, 
