...
knitr::include_graphics('man/figures/ofpe_data_workflow.png')
```
...
Example data used in the vignettes can be found [here](https://github.com/paulhegedus/OFPEDATA.git) and installed using the code above.
