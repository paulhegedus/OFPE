  ...
  public = list(
    ...
    executeOutput = function() {
      ...
      rx_sdt <- OFPE::getRxGrid(self$dbCon$db,
        ...
        ## TODO - orientation / buffer grid / make sure aligned N/S / rotate / make sure full
      ...
      ## TODO - make grid and field boundary in lat long to be N/S to line up 
      ## with edges. i.e. line grid with field edge (is this part of rrotatin??)
      ## need to make sure grid is N/S **** maybe do this above ****
  ...
  private = list(
    ...
    .stratDatRates = function(rx_sdt,
      ...
      for (i in 1:length(self$fieldname)) {
        ...
        if (length(unq_strat_combo) > min(exp_reps)) {
