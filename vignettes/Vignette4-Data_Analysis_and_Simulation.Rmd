...
ggmap::register_google(key = "AIzaSyAAmhnIJbTYa0G69NUCyMxePGjVV6FzciU")
...
```{r, eval = FALSE}
modClass$fitModels() %>% invisible() # 0.5min for nonlinear yield & gam protein, ~10min GAM, >0.5min for nonlinear
