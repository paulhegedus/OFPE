...
```{r, eval = FALSE}
pathToDat <- "~/INIT_UPLOADS/" # MAC # "C:/Users/paulhegedus/Documents/INIT_UPLOADS" # PC
...
```{r, eval = FALSE}
pathToDat <- "<your_google_drive_foldername>"
importGEE <- ImportGEE$new(dbCon, pathToDat, FALSE)
```

```{r, eval = FALSE, echo = FALSE}
pathToDat <- "GEE_Surfaces_4package"
importGEE <- ImportGEE$new(dbCon, pathToDat, TRUE)
```
...
```{r, out.width='100%', fig.align='center', fig.cap='**Figure 3.** Component diagram of the data import workflows...', echo = FALSE}
